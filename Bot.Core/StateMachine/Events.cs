...
/* money */
public record TransferCompleted(Guid CorrelationId, string TransactionId,
                                Guid? GoalIdIfAny = null);
public record TransferFailed   (Guid CorrelationId, string Reason);
public record BillPaid         (Guid CorrelationId, Guid BillId,
...
/* goals */
public record BudgetAlertTriggered(Guid CorrelationId, Guid GoalId,
