        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankLinked = table.Column<bool>(type: "boolean", nullable: false),
                    PinSet = table.Column<bool>(type: "boolean", nullable: false),
                    PinValidated = table.Column<bool>(type: "boolean", nullable: false),
                    ActiveBillId = table.Column<Guid>(type: "uuid", nullable: true),
                    ActiveRecurringId = table.Column<Guid>(type: "uuid", nullable: true),
                    ActiveGoalId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    TempNIN = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BotState", x => x.CorrelationId);
                });
